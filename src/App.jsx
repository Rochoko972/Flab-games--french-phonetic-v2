...
const NASAL_VOWELS = [
  { sound: "an/en", ipa: "/ɑ̃/", words: ["enfant", "dans", "manger"], wordsEn: ["child", "in", "to eat"], tip: "Open mouth wide + air through nose. Like 'on' in 'song' but more open.", spellings: ["an", "am", "en", "em"], color: "#0ea5e9" },
  ...
  { sound: "un", ipa: "/œ̃/", words: ["un", "brun", "lundi"], wordsEn: ["one", "brown", "Monday"], tip: "Round lips slightly + air through nose. Rare sound, merging with /ɛ̃/.", spellings: ["un", "um"], color: "#6366f1" },
];
    ...
    <div style={{ width: "100%", maxWidth: 860, transition: "all 0.8s cubic-bezier(0.16,1,0.3,1)", transform: isLocked ? "scale(0.94)" : "scale(1)", opacity: isLocked ? 0.35 : 1, pointerEvents: isLocked ? "none" : "auto" }}>
      <div style={{ borderRadius: 24, overflow: "hidden", background: isLocked ? "rgba(10,15,30,0.85)" : "rgba(255,255,255,0.96)", backdropFilter: "blur(24px)", border: isLocked ? "2px solid rgba(40,50,80,0.4)" : "2px solid rgba(226,232,240,0.6)", boxShadow: isLocked ? "none" : "0 20px 50px rgba(0,0,0,0.07)" }}>
        <header style={{ display: "flex", alignItems: "center", gap: 10, padding: "14px 18px", borderBottom: `1px solid ${isLocked ? "rgba(40,50,80,0.3)" : "#f1f5f9"}` }}>
          <div style={{ width: 34, height: 34, borderRadius: 9, background: isLocked ? "#1e293b" : "linear-gradient(135deg, #0ea5e9, #6366f1)", display: "flex", alignItems: "center", justifyContent: "center", color: "#fff", fontSize: 15, flexShrink: 0 }}>{isLocked ? "🔒" : "🔓"}</div>
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 2 }}>
              <span style={{ fontSize: 8, fontWeight: 800, padding: "2px 6px", borderRadius: 4, color: "#fff", background: isLocked ? "#334155" : "#0ea5e9" }}>LVL {index}</span>
...
const CoverSlide = ({ onStart, totalGems }) => (
  <section style={{ minHeight: "100vh", width: "100%", display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", padding: "24px 16px", position: "relative", overflow: "hidden", color: "#fff" }}>
    <div style={{ position: "absolute", inset: 0, background: "linear-gradient(160deg, #020617 0%, #0c1222 30%, #0a0f1e 60%, #020617 100%)" }} />
    <div style={{ position: "absolute", top: -120, right: -120, width: 400, height: 400, borderRadius: "50%", background: "radial-gradient(circle, rgba(14,165,233,0.2) 0%, transparent 65%)", filter: "blur(50px)" }} />
    <div style={{ position: "absolute", bottom: -120, left: -80, width: 350, height: 350, borderRadius: "50%", background: "radial-gradient(circle, rgba(99,102,241,0.15) 0%, transparent 65%)", filter: "blur(50px)" }} />
    <div style={{ position: "relative", zIndex: 10, textAlign: "center", maxWidth: 600, width: "100%" }}>
      <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(255,255,255,0.04)", padding: "6px 16px", borderRadius: 50, border: "1px solid rgba(255,255,255,0.06)", marginBottom: 28, animation: "fadeIn 0.8s" }}>
        ...
        <span style={{ textTransform: "uppercase", letterSpacing: 4, fontSize: 9, fontWeight: 700, color: "rgba(125,211,252,0.8)", fontFamily: "'JetBrains Mono', monospace" }}>System Online</span>
      </div>
      <h1 style={{ fontSize: "clamp(40px, 9vw, 90px)", fontWeight: 900, lineHeight: 0.88, margin: "0 0 8px", fontFamily: "'Outfit', sans-serif", animation: "fadeIn 0.8s 0.15s both" }}>
        <span style={{ background: "linear-gradient(135deg, #7dd3fc 0%, #38bdf8 30%, #0ea5e9 60%, #818cf8 100%)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>ESCAPE</span><br />
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 10, marginBottom: 10, animation: "fadeIn 0.8s 0.3s both" }}>
        <div style={{ height: 1, width: 30, background: "rgba(14,165,233,0.3)" }} />
        <p style={{ fontSize: "clamp(11px, 2vw, 16px)", fontWeight: 800, color: "#7dd3fc", letterSpacing: 4, fontFamily: "'JetBrains Mono', monospace", margin: 0 }}>PHONÉTIQUE</p>
        <div style={{ height: 1, width: 30, background: "rgba(14,165,233,0.3)" }} />
      </div>
      <div style={{ display: "inline-flex", background: "rgba(14,165,233,0.08)", border: "1px solid rgba(14,165,233,0.15)", padding: "4px 14px", borderRadius: 50, marginBottom: 28, animation: "fadeIn 0.8s 0.4s both" }}>
        <span style={{ fontSize: 10, fontWeight: 700, color: "#7dd3fc", letterSpacing: 2, fontFamily: "'JetBrains Mono', monospace" }}>PRONUNCIATION A1</span>
      </div>
      {totalGems > 0 && (
        <div style={{ marginBottom: 16, animation: "fadeIn 0.8s 0.45s both" }}>
          <span style={{ fontSize: 22 }}>💎</span>
          <span style={{ fontSize: 20, fontWeight: 900, color: "#0ea5e9", fontFamily: "'Outfit'", marginLeft: 6 }}>{totalGems}</span>
      ...
      <button onClick={() => { V.sfx("unlock"); onStart(); }}
        style={{ background: "linear-gradient(135deg, #0ea5e9, #a855f7)", color: "#fff", border: "none", padding: "16px 36px", borderRadius: 14, fontSize: 15, fontWeight: 800, cursor: "pointer", boxShadow: "0 0 40px rgba(14,165,233,0.25)", fontFamily: "'Outfit', sans-serif", letterSpacing: 1, width: "100%", maxWidth: 280, animation: "fadeIn 0.8s 0.65s both" }}>
        ENTER SOUND LAB ⬇
      </button>
    ...
    <div>
        ...
        {ALPHABET.map((item) => {
          ...
          return (
            <button key={item.letter} onClick={() => handleLetterClick(item)}
              style={{ height: 42, borderRadius: 10, border: isActive ? "2px solid #0ea5e9" : "1px solid #f1f5f9", background: isActive ? "#0ea5e9" : isExplored ? "#f0f9ff" : "#fff", color: isActive ? "#fff" : isTricky ? "#0ea5e9" : "#334155", fontWeight: 900, fontSize: 16, cursor: "pointer", fontFamily: "'Outfit'", transition: "all 0.15s", position: "relative" }}>
              {item.letter}
              {isTricky && !isActive && <span style={{ position: "absolute", top: 1, right: 2, fontSize: 6, color: "#0ea5e9" }}>⚠</span>}
            </button>
          );
        })}
      </div>
      {activeLetter && (
        <div style={{ background: "#0f172a", borderRadius: 16, padding: "18px 16px", color: "#fff", animation: "fadeIn 0.2s", marginBottom: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 8 }}>
            ...
            <div>
              <div style={{ fontSize: 14, color: "#7dd3fc", fontFamily: "'JetBrains Mono', monospace" }}>French: "{activeLetter.sound}"</div>
          ...
          <div style={{ background: "rgba(14,165,233,0.1)", border: "1px solid rgba(14,165,233,0.2)", borderRadius: 10, padding: "8px 12px", fontSize: 12, color: "#7dd3fc" }}>
            {"💡"} {activeLetter.tip}
          </div>
        </div>
      )}
      {explored.size >= 20 && (
        <button onClick={() => { V.sfx("click"); setPhase("quiz"); }}
          style={{ display: "block", margin: "0 auto", padding: "12px 28px", background: "linear-gradient(135deg, #0ea5e9, #a855f7)", color: "#fff", border: "none", borderRadius: 12, fontWeight: 800, cursor: "pointer", fontFamily: "'Outfit'", fontSize: 14, animation: "bounceIn 0.4s" }}>
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <button onClick={playQuizLetter}
        style={{ width: 90, height: 90, borderRadius: "50%", border: "none", background: "linear-gradient(135deg, #0ea5e9, #a855f7)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 8px", fontSize: 32, boxShadow: "0 6px 24px rgba(14,165,233,0.3)", animation: "pulse 2s infinite" }}>
        🔊
      </button>
    ...
    <div>
        ...
        <div style={{ background: "#0f172a", borderRadius: 18, padding: "20px 18px", color: "#fff", animation: "fadeIn 0.2s", marginBottom: 12 }}>
          <div style={{ display: "flex", alignItems: "start", gap: 16 }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <p style={{ margin: "0 0 8px", fontSize: 12, color: "#7dd3fc", lineHeight: 1.5 }}>{activeVowel.tip}</p>
      ...
      {explored.size >= ORAL_VOWELS.length && (
        <button onClick={() => { addGems(GEMS_PER_LEVEL); V.sfx("unlock"); setTimeout(onUnlock, 500); }}
          style={{ display: "block", margin: "0 auto", padding: "14px 32px", background: "linear-gradient(135deg, #0ea5e9, #a855f7)", color: "#fff", border: "none", borderRadius: 14, fontWeight: 800, cursor: "pointer", fontFamily: "'Outfit'", fontSize: 14, animation: "bounceIn 0.4s" }}>
  ...
  return (
    <div>
            ...
            <div key={nv.sound} onClick={() => { V.sfx("click"); V.say(nv.words[0]); setActiveNasal(nv); const ne = new Set(explored); ne.add(nv.sound); setExplored(ne); }}
              ...
              {isActive && (
                <div style={{ animation: "fadeIn 0.2s" }}>
                  ...
                  <p style={{ fontSize: 11, color: "#7dd3fc", marginTop: 8, lineHeight: 1.5 }}>{nv.tip}</p>
      ...
      {explored.size >= NASAL_VOWELS.length && (
        <button onClick={() => { addGems(GEMS_PER_LEVEL); V.sfx("unlock"); setTimeout(onUnlock, 500); }}
          style={{ display: "block", margin: "0 auto", padding: "14px 28px", background: "linear-gradient(135deg, #0ea5e9, #a855f7)", color: "#fff", border: "none", borderRadius: 14, fontWeight: 800, cursor: "pointer", fontFamily: "'Outfit'", animation: "bounceIn 0.4s" }}>
            ...
            <div key={c.sound} onClick={() => { V.sfx("click"); V.say(c.words[0]); setActive(c); const ne = new Set(explored); ne.add(c.sound); setExplored(ne); }}
              ...
              {isA && (
                <div style={{ marginTop: 12, animation: "fadeIn 0.2s" }}>
                  <p style={{ fontSize: 12, color: "#7dd3fc", lineHeight: 1.5, margin: "0 0 10px" }}>{c.tip}</p>
        ...
        {SOUND_COMBOS.map(c => {
          ...
          return (
            <div key={c.combo} onClick={() => { V.sfx("click"); V.say(c.words[0]); setActive(c); const ne = new Set(explored); ne.add(c.combo); setExplored(ne); }}
              style={{ padding: "14px", borderRadius: 14, border: isA ? "2px solid #0ea5e9" : "1px solid #f1f5f9", background: isA ? "#0f172a" : "#fff", color: isA ? "#fff" : "#0f172a", cursor: "pointer", transition: "all 0.2s" }}>
              <div style={{ fontSize: 22, fontWeight: 900, fontFamily: "'Outfit'", color: isA ? "#7dd3fc" : "#0ea5e9", textTransform: "uppercase" }}>{c.combo}</div>
              ...
              {isA && (
                <div style={{ marginTop: 8, animation: "fadeIn 0.2s" }}>
                  <p style={{ fontSize: 11, color: "#7dd3fc", margin: "0 0 6px" }}>{c.tip}</p>
                  {c.words.map((w, i) => (
    ...
    <div>
      ...
      <div style={{ background: "#0f172a", borderRadius: 16, padding: "18px 16px", marginBottom: 16, color: "#fff" }}>
        <div onClick={() => setShowRules(!showRules)} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", cursor: "pointer" }}>
          <h4 style={{ margin: 0, fontSize: 14, fontWeight: 800, color: "#7dd3fc", fontFamily: "'Outfit'" }}>{"📖"} LIAISON RULES</h4>
        ...
        {LIAISON_RULES.map((l, i) => {
          ...
          return (
            <div key={i} onClick={() => { V.sfx("click"); V.say(l.example, 0.7); setActive(i); const ne = new Set(explored); ne.add(i); setExplored(ne); }}
              style={{ padding: "14px 16px", borderRadius: 14, border: isA ? "2px solid #0ea5e9" : "1px solid #f1f5f9", background: isA ? "#0f172a" : "#fff", color: isA ? "#fff" : "#0f172a", cursor: "pointer", transition: "all 0.2s" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontSize: 16, fontWeight: 800, fontFamily: "'Outfit'" }}>{l.example} <SpeakBtn text={l.example} size={14} /></span>
                <span style={{ fontSize: 9, background: isA ? "rgba(14,165,233,0.2)" : "#f8fafc", padding: "3px 8px", borderRadius: 6, fontWeight: 700, color: isA ? "#7dd3fc" : "#64748b" }}>{l.rule}</span>
              </div>
              {isA && (
                <div style={{ marginTop: 10, animation: "fadeIn 0.2s" }}>
                  ...
                  <p style={{ fontSize: 12, color: "#7dd3fc", margin: 0 }}>{l.tip}</p>
...
const CertificateSlide = ({ totalGems }) => (
  <div style={{ textAlign: "center" }}>
    <div style={{ background: "#fffbf0", border: "3px solid #0f172a", padding: "36px 28px", maxWidth: 520, margin: "0 auto", position: "relative" }}>
      ...
      <div style={{ background: "#0ea5e9", color: "#fff", display: "inline-block", padding: "3px 12px", fontSize: 8, fontWeight: 800, letterSpacing: 3, textTransform: "uppercase", marginBottom: 16 }}>Official Document</div>
      ...
      <div style={{ borderBottom: "3px solid #0f172a", maxWidth: 300, margin: "0 auto 20px" }}>
        <input type="text" placeholder="YOUR NAME" style={{ width: "100%", textAlign: "center", fontSize: "clamp(18px, 4vw, 30px)", fontWeight: 900, background: "transparent", border: "none", outline: "none", color: "#0ea5e9", textTransform: "uppercase", paddingBottom: 4, fontFamily: "'Outfit'" }} />
      </div>
...
const ConsonantQuiz = ({ onUnlock, addGems }) => {
  ...
  return (
    <div style={{ textAlign: "center" }}>
      ...
      <div style={{ display: "flex", justifyContent: "center", gap: 8, flexWrap: "wrap", marginBottom: 16 }}>
        {q.options.map(opt => (<button key={opt} onClick={() => { V.sfx("click"); setSelected(opt); }} style={{ padding: "14px 22px", borderRadius: 12, border: selected === opt ? "2px solid #0ea5e9" : "1px solid #e2e8f0", background: selected === opt ? "#0ea5e9" : "#fff", color: selected === opt ? "#fff" : "#334155", fontWeight: 900, fontSize: 18, cursor: "pointer", fontFamily: "'Outfit'" }}>{opt}</button>))}
      </div>
  ...
  return (
    <div>
      ...
      <div style={{ width: "100%", height: 5, background: "#1e293b", borderRadius: 3, marginBottom: 14, overflow: "hidden" }}>
        <div style={{ width: `${(idx/ALL_Q.length)*100}%`, height: "100%", background: "linear-gradient(90deg,#0ea5e9,#a855f7)", transition: "width 0.5s", borderRadius: 3 }} />
      </div>
      <div style={{ textAlign: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 8, flexWrap: "wrap", margin: "12px 0" }}>
          {q.options.map(o => (<button key={o} onClick={() => { V.sfx("click"); setSel(o); }} style={{ padding: "12px 18px", borderRadius: 12, border: sel === o ? "2px solid #0ea5e9" : "1px solid #e2e8f0", background: sel === o ? "#0ea5e9" : "#fff", color: sel === o ? "#fff" : "#334155", fontWeight: 800, fontSize: 14, cursor: "pointer", fontFamily: "'Outfit'", textTransform: "uppercase" }}>{o}</button>))}
        </div>
  ...
  return (
    <div style={{ display: "flex", background: "#020617", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif", overflowX: "hidden" }}>
      ...
      <div className="mob-top" style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 100, background: "rgba(8,12,25,0.96)", backdropFilter: "blur(12px)", borderBottom: "1px solid #1e293b", padding: "10px 14px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div><span style={{ fontWeight: 900, fontSize: 13, color: "#fff", fontFamily: "'Outfit'" }}>ESCAPE FLAB</span><span style={{ fontSize: 8, color: "#0ea5e9", marginLeft: 6, fontFamily: "'JetBrains Mono', monospace" }}>PHONÉTIQUE</span></div>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <span style={{ fontSize: 12 }}>💎 <strong style={{ color: "#0ea5e9" }}>{gems}</strong></span>
        ...
        <div onClick={() => setSidebarOpen(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.6)", zIndex: 90 }}>
          <div onClick={e => e.stopPropagation()} style={{ position: "absolute", top: 48, right: 0, width: 250, maxHeight: "calc(100vh - 56px)", overflowY: "auto", background: "rgba(8,12,25,0.98)", borderLeft: "1px solid #1e293b", padding: "14px 10px" }}>
            {SECTIONS.map((s, idx) => {
              ...
              return (<div key={s.id} style={{ padding: "7px 10px", borderRadius: 8, fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.8, color: isC ? "#0ea5e9" : isU ? "rgba(52,211,153,0.55)" : "#1e293b" }}><span style={{ fontSize: 10, marginRight: 6 }}>{isU ? "✅" : "🔒"}</span>{s.title}</div>);
            })}
          </div>
        </div>
      )}
      ...
      <aside className="desk-side" style={{ display: "flex", flexDirection: "column", width: 210, height: "100vh", position: "sticky", top: 0, borderRight: "1px solid #1e293b", background: "rgba(8,12,25,0.96)", zIndex: 50, overflowY: "auto", flexShrink: 0 }}>
        <div style={{ padding: "18px 14px", borderBottom: "1px solid #1e293b" }}>
          ...
          <p style={{ fontSize: 8, color: "#7dd3fc", fontWeight: 700, letterSpacing: 2, margin: 0, fontFamily: "'JetBrains Mono', monospace" }}>PHONÉTIQUE • A1</p>
          <div style={{ marginTop: 12, display: "flex", alignItems: "center", gap: 6 }}>
            <span style={{ fontSize: 14 }}>💎</span>
            <span style={{ fontSize: 16, fontWeight: 900, color: "#0ea5e9", fontFamily: "'Outfit'" }}>{gems}</span>
          </div>
          <div style={{ marginTop: 10 }}>
            <div style={{ width: "100%", height: 3, background: "#1e293b", borderRadius: 3, overflow: "hidden" }}>
              <div style={{ width: `${(level / SECTIONS.length) * 100}%`, height: "100%", background: "linear-gradient(90deg, #0ea5e9, #a855f7)", transition: "width 1s", borderRadius: 3 }} />
            </div>
